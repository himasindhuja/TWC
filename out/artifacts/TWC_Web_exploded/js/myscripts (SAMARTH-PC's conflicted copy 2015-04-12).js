	...
	function setPageSVG(val, fileName) {
		limit = val;
		filePath = fileName;
		/*alert("Inside setPageSVG " + val + "  " + fileName);*/
	...
	function getSVG() {
		...
		// alert(x);
		alert(filePath+x+".csv?"+Math.random()*Math.random());
		d3.csv(filePath+x+".csv?"+Math.random()*Math.random(), function(topic) {
